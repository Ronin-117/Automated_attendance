...
def send_email(subject= "Attendace", body= "Automated mail sending Attendance csv", to_email="nj6604053@gmail.com",attachment_path="Attendance.csv"):#Modify you target email address 
    try:
        # Your Gmail account credentials
        from_email = "njytc001@gmail.com" #enter your email
        password = "omqs mzve mikw cybg" #enter you device password (not the email password)
        ...
        if not success:
            ...
            if do_inference:
                ...
                for encodeFace, faceLoc in zip(encodesCurFrame, facesCurFrame):
                    ...
                    # Check if the face distance is within the acceptable range
